...
const GALLERY = ["home12.png", "home11.png", "home10.png"];

const UNIT_PRICE = 40; // price per unit at 50 qty
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10 py-6 grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div>
          ...
          <p className="mt-3 text-[13.5px]" style={{ color: "#5B6072" }}>
            Get your logo noticed with this speaker and alarm clock combo
          </p>
          ...
          {/* ---- Upload design ---- */}
          <Link to="/design-studio" state={{ name: "Buzz", unitPrice: unitForQty, qty, size }}>
            <motion.div
