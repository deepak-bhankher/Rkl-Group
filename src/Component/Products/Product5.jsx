...
// e.g. "/products/ledger/1.jpg"
const GALLERY = ["home6.png", "home5.png", "home4.png"];

const UNIT_PRICE = 10; // price per unit at 50 qty
    ...
    <div style={{ fontFamily: "Inter, system-ui, sans-serif", background: C.paper, minHeight: "100vh" }}>
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10 pt-6">
        <div className="flex items-center gap-1.5 text-[12.5px]" style={{ color: "#7A8092" }}>
          ...
          <ChevronRight size={13} />
          <span style={{ color: C.ink, fontWeight: 600 }}>Ledger</span>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10 py-6 grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div>
          ...
          <p className="mt-3 text-[13.5px]" style={{ color: "#5B6072" }}>
            Get your logo noticed with this hardbound A5 notebook
          </p>
          ...
          {/* ---- Upload design ---- */}
          <Link to="/design-studio" state={{ name: "Ledger", unitPrice: unitForQty, qty, size }}>
            <motion.div
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10 py-10">
        <div className="flex gap-6 border-b" style={{ borderColor: "rgba(11,27,58,0.1)" }}>
          {["description", "specifications", "reviews"].map((t) => (
            ...
            >
              {t}
              {tab === t && (
                <motion.div layoutId="tabLine-Product5" className="absolute bottom-0 left-0 right-0 h-[2px]" style={{ background: C.gold }} />
              )}
            </button>
          ))}
        </div>
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            style={{ color: "#5B6072" }}
          >
            {tab === "description" && <p>Ledger is a hardbound A5 notebook with thick, smooth pages that don't bleed through — a dependable everyday notebook that also makes a thoughtful, brandable corporate gift.</p>}
            {tab === "specifications" && (
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-2">
                <li>Size: A5 (14.8 x 21cm)</li>
                <li>Pages: 192, ruled</li>
                <li>Cover: Hardbound, vegan leather finish</li>
                <li>Paper: 100 GSM</li>
                <li>Extras: Ribbon bookmark, elastic closure</li>
                <li>Branding space: Cover, 8 x 3cm</li>
              </ul>
            )}
            {tab === "reviews" && (
