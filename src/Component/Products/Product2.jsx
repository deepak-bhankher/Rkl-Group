...
// e.g. "/products/tango/1.jpg"
const GALLERY = ["home18.png", "home17.png", "home16.png"];
    ...
    <div style={{ fontFamily: "Inter, system-ui, sans-serif", background: C.paper, minHeight: "100vh" }}>
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10 pt-6">
        <div className="flex items-center gap-1.5 text-[12.5px]" style={{ color: "#7A8092" }}>
          ...
          <ChevronRight size={13} />
          <span style={{ color: C.ink, fontWeight: 600 }}>Tango</span>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10 py-6 grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div>
          ...
          <p className="mt-3 text-[13.5px]" style={{ color: "#5B6072" }}>
            Get your logo noticed with this compact water-resistant speaker
          </p>
          ...
          {/* ---- Upload design ---- */}
          <Link to="/design-studio" state={{ name: "Tango", unitPrice: unitForQty, qty, size }}>
            <motion.div
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10 py-10">
        <div className="flex gap-6 border-b" style={{ borderColor: "rgba(11,27,58,0.1)" }}>
          {["description", "specifications", "reviews"].map((t) => (
            ...
            >
              {t}
              {tab === t && (
                <motion.div layoutId="tabLine-Product2" className="absolute bottom-0 left-0 right-0 h-[2px]" style={{ background: C.gold }} />
              )}
            </button>
          ))}
        </div>
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            style={{ color: "#5B6072" }}
          >
            {tab === "description" && <p>Tango is a compact, water-resistant Bluetooth speaker built for life outdoors. IPX4 splash protection, punchy bass and a clip-on hook mean it travels as easily as it plays — from the balcony to the trail.</p>}
            {tab === "specifications" && (
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-2">
                <li>Diameter: 10 x 4.1cm</li>
                <li>Output: 5W</li>
                <li>Battery: 4 hours play time</li>
                <li>Range: 10m Bluetooth</li>
                <li>Water resistance: IPX4</li>
                <li>Extras: Built-in mic, TWS connectivity</li>
              </ul>
            )}
            {tab === "reviews" && (
